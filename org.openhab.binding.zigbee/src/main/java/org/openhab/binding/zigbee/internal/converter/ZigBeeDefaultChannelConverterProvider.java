...
public final class ZigBeeDefaultChannelConverterProvider implements ZigBeeChannelConverterProvider {
    ...
    public ZigBeeDefaultChannelConverterProvider() {
        ...
        channelMap.put(ZigBeeBindingConstants.CHANNEL_ANALOGINPUT, ZigBeeConverterAnalogInput.class);
        channelMap.put(ZigBeeBindingConstants.CHANNEL_MULTISTATEINPUT, ZigBeeConverterMultistateInput.class);
